...
if ($total_anomalies > 0) {
    ...
    if ($count_price > 0) {
        $ai_message .= " Turut dikesan {$count_price} kenderaan dengan nilai duti luar biasa tinggi yang memerlukan verifikasi khas.";
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="relative mb-10">
                            <p class="text-lg text-slate-700 leading-relaxed font-semibold italic">
                                ...
                                <span class="relative z-10"><?= htmlspecialchars($ai_message) ?></span>
                            </p>
                        </div>
